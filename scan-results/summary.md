...
#### Scanned Files
```
sboms/ADManager_Plus_SBOM.json
```

#### Latest Scan Results

##### Results for ADManager_Plus_SBOM.json

![IMG](https://raw.githubusercontent.com/devops-kung-fu/bomber/main/img/bomber-readme-logo.png)

The following results were detected by `bomber 0.5.1` on 2025-05-01 15:54:09.283343552 +0000 UTC m=+2.411240572 using the ossindex provider.
